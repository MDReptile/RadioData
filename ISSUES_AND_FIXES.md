...
case UartState.Idle:
    if (!_currentLevel) // Detected Space (Start Bit)
    {
        ...
        _samplesInCurrentState = -2; // ?? HARDCODED
    }
    break;
```
...
### 3. ?? MEDIUM: Baud Rate Documentation Mismatch
...
### 4. ?? MEDIUM: Device Index Confusion
...
### 5. ?? MEDIUM: Input Gain Clipping Distortion
...
### 6. ?? LOW: Inconsistent Preamble Duration
